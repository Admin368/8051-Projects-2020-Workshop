...
uchar xsegdelay = 1;
uchar xdigdelay = 2;
uchar xkey,xprekey,xeffector,xletter,changed;
...
uchar xgetfullkey();             //[paulobetaX2.h]
            ...
            case 9:
                ...
                break;
						case 'n': //displays nothing 
								P0 = 0x08;
								break;
						case 20://'+'displays 1 half of '+' symbol 
								P0 = 0x46;
								break;
						case 21://'+'displays 2nd half of '+' symbol
								P0 = 0x70;
								break;
			default:
                return;
