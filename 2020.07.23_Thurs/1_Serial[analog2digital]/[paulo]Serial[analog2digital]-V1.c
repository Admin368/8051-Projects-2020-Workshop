...
#include<intrins.h>
/*
// WE CCONNECTED THE LIGHT SENSOR
THE VOLTAGE IS HIGH WENDARK ,AS ITS RESISTANCE IST SMALLEST
NO LIGHT = 5V [255] [HIGH RESISTANCE]
YES LIGHT = 0V [0]  [LOW RESISTANCE]

CHAR HAS RANGE OF -127 TO 128

UNSIGNED CHAR THO HAS 0-255
...
unsigned char upperThres  =  100; //we will set a range as resistaster may not reach 255 exact
unsigned char lowerThres  =  204;
